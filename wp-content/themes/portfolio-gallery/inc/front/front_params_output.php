...
class Portfolio_gallery_front extends WDWT_frontend {
  ...
  public function media_queries(){
    ...
    $content_posts_layout = $this->get_param('content_posts_layout',array(),"thumb");
    ...
    <style>
      ...
      @media screen and (min-width: <?php echo $i; ?>px) {
        ...
        <?php if($content_posts_layout == "thumb" || !is_home()) : ?>
  ...
  public function color_control(){
    ...
    $caption_bg_color = $this->get_param('[colors_active][colors][caption_bg_color][value]', array(), '#000000');
    ...
    <style type="text/css">
      ...
      .da-empty .caption{
        background:<?php echo $this->hex_to_rgba($button_bg_color,0.5); ?>;
      }
      .button-color{
      ...
      .da-thumbs div article{
        background-color:<?php echo $this->hex_to_rgba($caption_bg_color,0.5); ?>;
      }
      .da-empty.on_hover .masonry_item_content{
        background-color:<?php echo $this->hex_to_rgba($button_bg_color,0.5); ?>;
      }
      .on_hover .masonry_item_content{
        background-color:<?php echo $this->hex_to_rgba($caption_bg_color,0.5); ?>;
      }
      .masonry_item_content{
        background-color:<?php echo $caption_bg_color; ?>;
      }

      .da-thumbs div article.da-empty{
        background-color:<?php echo $this->hex_to_rgba($button_bg_color,0.7); ?>;
  ...
  */
  ...
  public function social_links(){
    ...
    if($twt || $fb || $goo || $inst || $yout || $tumb || $fl || $pin || $dr || $px || $li || $snp){
      ?>
      <div class="wdwt-social-links">
        <div class="">
          <?php if(trim($header_for_links) != "") { ?>
            <h3><?php echo esc_html($header_for_links); ?></h3>
            <?php
          }
          if( $fb){ ?>
          ...
          <?php if( $li){ ?>
            <span class='wdwt-social-span'>
          <a class='wdwt-social-li wdwt-social-link' href='<?php echo esc_attr($this->get_param('linkedin_url', '')); ?>' target='_blank'><i class="fa fa-linkedin"></i>
          </a>
        </span>
          <?php } ?>
          <?php if( $snp){ ?>
            <span class='wdwt-social-span'>
          <a class='wdwt-social-snp wdwt-social-link' href='<?php echo esc_attr($this->get_param('snapchat_url', '')); ?>' target='_blank'><i class="fa fa-snapchat"></i>
          </a>
        </span>
          <?php } ?>
